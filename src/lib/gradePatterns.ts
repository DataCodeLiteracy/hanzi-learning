...
export const gradePatterns = {
  ...
  6: [
    { pattern: "sound", questionCount: 8, isTextBook: false },
    { pattern: "meaning", questionCount: 8, isTextBook: false },
    { pattern: "word_reading", questionCount: 8, isTextBook: true },
    { pattern: "word_meaning", questionCount: 8, isTextBook: false },
    { pattern: "blank_hanzi", questionCount: 2, isTextBook: true },
    { pattern: "word_meaning_select", questionCount: 2, isTextBook: true },
    { pattern: "hanzi_write", questionCount: 8, isTextBook: false },
    { pattern: "word_reading_write", questionCount: 4, isTextBook: true },
    { pattern: "sentence_reading", questionCount: 2, isTextBook: true },
  ],
  5: [
